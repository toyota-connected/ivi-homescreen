...
/****************************************************************
Test Case Name.Test Name： ivi-homescreen_utils_rtrim_Lv1Normal001
Use Case Name: Intialization
Test Summary：Test the function of rtrim
***************************************************************/

TEST(ivi-homescreen_utils_rtrim, Lv1Normal001) {
...
/****************************************************************
Test Case Name.Test Name： ivi-homescreen_utils_ltrim_Lv1Normal001
Use Case Name: Intialization
Test Summary：Test the function of ltrim
***************************************************************/

TEST(ivi-homescreen_utils_ltrim, Lv1Normal001) {
    std::string input = "unit test";
...
/****************************************************************
Test Case Name.Test Name： ivi-homescreen_utils_trim_Lv1Normal001
Use Case Name: Intialization
Test Summary：Test the function of trim
***************************************************************/

TEST(ivi-homescreen_utils_trim, Lv1Normal001) {
    std::string input = "unit test";
