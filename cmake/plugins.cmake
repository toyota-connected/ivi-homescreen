...
option(BUILD_PLUGIN_GSTREAMER "Include GStreamer Plugin" ON)
if (BUILD_PLUGIN_GSTREAMER)
    ENABLE_PLUGIN(gstreamer)
    pkg_check_modules(PLUGIN_GSTREAMER REQUIRED gstreamer-1.0>=1.4 gstreamer-video-1.0>=1.4 libavformat)
endif ()
...
if (BUILD_PLUGIN_SECURE_STORAGE)
    ...
    pkg_check_modules(PLUGIN_SECURE_STORAGE REQUIRED libsecret-1 jsoncpp)
endif ()
