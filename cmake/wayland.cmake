...
if (ENABLE_AGL_CLIENT AND ENABLE_IVI_SHELL_CLIENT)
    message(WARNING "ENABLE_AGL_CLIENT and ENABLE_IVI_SHELL_CLIENT options are mutually exclusive.")
    message(WARNING "Disabling ENABLE_IVI_SHELL_CLIENT.")
    set(ENABLE_IVI_SHELL_CLIENT OFF)
endif ()
if (ENABLE_AGL_CLIENT AND NOT ENABLE_XDG_CLIENT)
    message(WARNING "ENABLE_AGL_CLIENT is dependent on ENABLE_XDG_CLIENT.")
    set(ENABLE_XDG_CLIENT ON)
endif ()

if (ENABLE_XDG_CLIENT)
    target_compile_definitions(wayland-gen PUBLIC ENABLE_XDG_CLIENT)
    message(STATUS "Enabling Shell: XDG")
endif ()
if (ENABLE_AGL_CLIENT)
    target_compile_definitions(wayland-gen PUBLIC ENABLE_AGL_CLIENT)
    message(STATUS "Enabling Shell: AGL")
endif ()
if (ENABLE_IVI_SHELL_CLIENT)
    target_compile_definitions(wayland-gen PUBLIC ENABLE_IVI_SHELL_CLIENT)
    message(STATUS "Enabling Shell: IVI")
endif ()
