...
#include "models/scene/camera/camera.h"

#include "ground.h"
#include "models/scene/indirect_light/indirect_light.h"
#include "models/scene/light/light.h"
#include "models/scene/skybox/skybox.h"
