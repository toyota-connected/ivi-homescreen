...
#ifndef FLUTTER_PLUGIN_NAV_RENDER_PLUGIN_H_
#define FLUTTER_PLUGIN_NAV_RENDER_PLUGIN_H_
...
class NavRenderViewPlugin final : public flutter::Plugin,
                                  public NavRenderViewApi,
                                  public PlatformView {
 public:
  ...
  NavRenderViewPlugin(int32_t id,
                      std::string viewType,
                      int32_t direction,
                      double top,
                      double left,
  ...
  ~NavRenderViewPlugin() override;

  // Disallow copy and assign.
  NavRenderViewPlugin(const NavRenderViewPlugin&) = delete;
  NavRenderViewPlugin& operator=(const NavRenderViewPlugin&) = delete;
...
#endif  // FLUTTER_PLUGIN_NAV_RENDER_PLUGIN_H_