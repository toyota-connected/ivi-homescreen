...
#ifndef PIGEON_MESSAGES_G_H
#define PIGEON_MESSAGES_G_H
...
class PigeonStorageFirebaseApp {
 public:
  ...
  explicit PigeonStorageFirebaseApp(std::string  app_name,
                                    std::string  bucket);
...
class PigeonStorageReference {
 public:
  // Constructs an object setting all fields.
  explicit PigeonStorageReference(std::string  bucket,
...
class PigeonListResult {
 public:
  // Constructs an object setting all non-nullable fields.
  explicit PigeonListResult(flutter::EncodableList  items,
                            flutter::EncodableList  prefixs);
...
class FirebaseStorageHostApi {
 public:
  ...
  virtual ~FirebaseStorageHostApi() = default;
