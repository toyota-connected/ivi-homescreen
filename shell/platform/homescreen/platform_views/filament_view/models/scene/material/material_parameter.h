...
#include "platform_views/filament_view/models/scene/material/texture/texture.h"
#include "platform_views/filament_view/models/scene/material/texture/texture_sampler.h"

namespace view_filament_view {
class MaterialParameter {
 public:
  MaterialParameter(void* parent,
                    const std::string& flutter_assets_path,
                    const flutter::EncodableMap& params);
  ~MaterialParameter();
  void Print(const char* tag);
  FML_DISALLOW_COPY_AND_ASSIGN(MaterialParameter);
